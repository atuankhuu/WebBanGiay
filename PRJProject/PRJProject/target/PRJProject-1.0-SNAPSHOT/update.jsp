            ...
            <div class="row justify-content-around">
                <form
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<%= p.getProduct_name()%>" name="pro_name" id="pro_name" />
                    </div>
                    <div class="mb-3">
                        <label for="pro_pic">File hinh anh: </label>
                        <input required type="file" name="pro_pic" class="form-control" id="pro_pic" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pro_price" value="<%= p.getPrice()%>" class="form-control" id="pro_price" />
                    </div>
                    <div class="mb-3">
                        <label for="pro_quan">So Luong: </label>
                        <input type="text" name="pro_quan" value="<%= p.getStock_quantity()%>" class="form-control" id="pro_quan" />
                    </div>
                    <div class="mb-3">
                        <label for="pro_des">Mo ta san pham: </label>
                        <input type="text" name="pro_des" value="<%= p.getDes()%>" class="form-control" id="pro_des"/>
                    </div>
