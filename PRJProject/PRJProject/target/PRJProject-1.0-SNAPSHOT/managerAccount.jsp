                        ...
                        <table id="example">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-middle">isSell</th>
                                    <th class="align-middle">isAdmin</th>
                                    <th class="align-middle"  >optine</th>
                            ...
                            <tbody>
                                <c:forEach items="${listAc}" var="o" varStatus="status">
                                    <tr >
                                        ...
                                        <th class="align-middle">${o.username}</th>
                                        <td class="align-middle"><p>${o.password}</p></td>
                                        <td class="align-middle"><p>${o.fullname}</p></td>
                                        <td class="align-middle"><p>${o.phone_number}</p></td>
                                        <td class="align-middle"><p>${o.email}</p></td>
                                        <td class="align-middle"><p>${o.isSell}</p></td>
                                        <td class="align-middle"><p>${o.isAdmin}</p></td>
                                        <td class="align-middle">
                                            <a href="/PRJProject/manager/Account/DeleteAccount/${o.account_id}" class="btn btn-light" data-toggle="modal">
                                                <i class='bx bx-cart-download'></i> 
                                                <span>Delete</span>
                                            </a>
                                        </td>
