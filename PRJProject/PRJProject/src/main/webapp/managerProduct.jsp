                ...
                <div class="modal-content">
                    <form
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Image</label>
                                <input name="pro_pic" type="file" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Color</label>
                            ...
                            <div class="form-group">
                                <label>Price</label>
                                <textarea name="pro_price" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>Stock_quantity</label>
                                <textarea name="pro_quan" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                    ...
                    <form>
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pro_quan" class="form-control" id="pro_quan" />
                            </div>	
                            <div class="form-group">
